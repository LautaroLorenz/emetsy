...
exports.seed = async function (knex) {
  await knex('essay_templates_steps').insert([
    ...
    { id: 3, order: 3, essay_template_id: 30, step_id: 3, actions_raw_data: '{"actions":[{"actionName":"Valores generales de la prueba","testName":"Prueba de constraste 5%","meterConstant":1,"phaseL1":{"voltageU1":1,"currentI1":2,"anglePhi1":3},"phaseL2":{"voltageU2":4,"currentI2":5,"anglePhi2":6},"phaseL3":{"voltageU3":7,"currentI3":8,"anglePhi3":9}},{"actionName":"Parámetros para la prueba de contraste","maxAllowedError":10,"meterPulses":11,"numberOfDiscardedResults":5}]}' },
  ]);
};
