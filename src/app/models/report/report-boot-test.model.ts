...
export class ReportBootTestBuilder extends ReportBuilder {
  override data: ReportBootTest = {} as ReportBootTest;
  ...
  reset(): void {
    this.data = {} as ReportBootTest;
  }

  override patchValue(value: Partial<ReportBootTest>) {
    this.data = {
      ...this.data,
      ...value
    };
