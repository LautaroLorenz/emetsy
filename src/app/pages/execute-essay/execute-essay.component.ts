...
import { Action, ContrastTestStep, EssayTemplate, EssayTemplateDbTableContext, ExecutionStatus, PageUrlName, PhotocellAdjustmentStep, PreparationStep, RelationsManager, ReportBodyBuilder, ReportStep, StepBuilder, WhereKind, WhereOperator } from 'src/app/models';
...
export class ExecuteEssayComponent implements OnInit, OnDestroy {
  ...
  private buildStepById(step_id: number, essayTemplateStep: EssayTemplateStep): StepBuilder {
    ...
    return new StepBuilder(essayTemplateStep, [], [], new ReportBodyBuilder());
  }
