...
import { CalculatorParams, Command, CommandManager, Device, DeviceStatus, DeviceStatusEnum, PROTOCOL, ResponseStatus, ResponseStatusEnum } from "../models";
...
export class CalculatorService implements Device {
  ...
  turnOn$(
    ...
    // );
    // TODO:
    const command: Command = `B| PCS| CAL| ${essayType}| 1234567891| 00000015| P0101200| P0201200| P0300750| P04     | P06     | P07     | P08     | P09     | P10     | P11     | P12     | P13     | P14     | P15     | P16     | P17     | P18     | P19     | P20     | Z| `;
    return of(true).pipe(
      takeUntil(this.sendStoper$),
